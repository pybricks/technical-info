...
local type_ids = {
    ...
    [0x001B] = "Unknown",
    [0x001C] = "Unknown",
    [0x001D] = "EV3 Color Sensor",
    [0x001E] = "EV3 Ultrasonic Sensor",
    [0x001F] = "Unknown",
    [0x0020] = "EV3 Gyro Sensor",
    [0x0021] = "EV3 Infrared Sensor",
    ...
    [0x002A] = "DUPLO Train Piezo Buzzer",
    [0x002B] = "DUPLO Train Color Sensor",
    [0x002C] = "DUPLO Train Speed",
    [0x002E] = "Technic Large Linear Motor",
    [0x002F] = "Technic XL Linear Motor",
    [0x0030] = "SPIKE Medium Angular Motor",
    [0x0031] = "SPIKE Large Angular Motor",
    [0x0032] = "Unknown",
    [0x0033] = "Unknown",
    [0x0034] = "Unknown",
    [0x0035] = "Unknown",
    [0x0036] = "Powered Up hub IMU gesture",
    [0x0037] = "Powered Up hub buttons (Handset)",
    [0x0038] = "Powered Up hub Bluetooth RSSI",
    ...
    [0x003D] = "SPIKE Color sensor",
    [0x003E] = "SPIKE Ultrasonic sensor",
    [0x003F] = "SPIKE Force sensor",
    [0x0040] = "Unknown",
    [0x0041] = "Unknown",
    [0x0042] = "Unknown",
    [0x0043] = "Unknown",
    [0x0044] = "Unknown",
    [0x0045] = "Unknown",
    [0x0046] = "Mario Unknown",
    [0x0047] = "Mario Unknown",
    [0x0048] = "Unknown",
    [0x0049] = "Mario Unknown",
    [0x004A] = "Mario Unknown",
    [0x004B] = "Technic Medium Angular Motor, gray",
    [0x004C] = "Technic Large Angular motor, gray",
    [0x004D] = "Unknown",
    [0x004E] = "Unknown",
    [0x004F] = "Unknown",
    [0x0050] = "Unknown",
